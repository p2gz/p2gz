    ...
    root_layer = (new ListMenu())
		...
		->push(new OpenSubMenuOption("pikmin", (new ListMenu())
			...
			->push(new OpenSubMenuOption("onions", (new GridMenu(100.0f, 36.0f))
				...
				->push_to_row(new ToggleMenuOption("ro", false, new Delegate1<OnionEditor, bool>(p2gz->onion_editor, &OnionEditor::set_unlocked), "onion_red", true))
				->end_row()
				...
				->push_to_row(new ToggleMenuOption("yo", false, new Delegate1<OnionEditor, bool>(p2gz->onion_editor, &OnionEditor::set_unlocked), "onion_yellow", true))
				->end_row()
				...
				->push_to_row(new ToggleMenuOption("ps", false, new Delegate1<OnionEditor, bool>(p2gz->onion_editor, &OnionEditor::set_unlocked), "ship_purple", true))
				->end_row()
				...
				->push_to_row(new ToggleMenuOption("ws", false, new Delegate1<OnionEditor, bool>(p2gz->onion_editor, &OnionEditor::set_unlocked), "ship_white", true))
			))
		))
