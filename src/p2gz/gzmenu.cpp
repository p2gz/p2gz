...
void GZMenu::init_menu()
{
    ...
    root_layer = (new ListMenu())
		->push(new OpenSubMenuOption("warp", (new ListMenu(new Delegate<Warp>(p2gz->warp, &Warp::sync)))
			...
			->push(new RadioMenuOption("category", new Delegate1<Warp, size_t>(p2gz->warp, &Warp::set_warp_category)))
		...
		->push(new OpenSubMenuOption("race", (new ListMenu(new Delegate<RaceMode>(p2gz->race_mode, &RaceMode::sync_menu)))
			->push(new RadioMenuOption("category", new Delegate1<RaceMode, size_t>(p2gz->race_mode, &RaceMode::set_category)))
			->push(new RadioMenuOption("start point", new Delegate1<RaceMode, size_t>(p2gz->race_mode, &RaceMode::set_start_point)))
			...
			->push(new ToggleMenuOption("skippable cutscenes", true, new Delegate1<RaceMode, bool>(p2gz->race_mode, &RaceMode::set_race_skippable_cs)))
			->push(new ToggleMenuOption("skip save prompts", true, new Delegate1<RaceMode, bool>(p2gz->race_mode, &RaceMode::set_race_skip_save)))
			->push(new PerformActionMenuOption("start", new Delegate<RaceMode>(p2gz->race_mode, &RaceMode::start_run)))
		))
		...
		->push(new OpenSubMenuOption("trainers", (new ListMenu())
			...
			->push(new OpenSubMenuOption("early blues", (new ListMenu())
				->push(new PerformActionMenuOption("start", new Delegate<EarlyBluesTrainer>(p2gz->early_blues_trainer, &EarlyBluesTrainer::start)))
				->push(new ToggleMenuOption("invert inset cam horizontally", true, new Delegate1<EarlyBluesTrainer, bool>(p2gz->early_blues_trainer, &EarlyBluesTrainer::toggle_inset_horizontal_inversion)))
				->push(new ToggleMenuOption("invert inset cam vertically", false, new Delegate1<EarlyBluesTrainer, bool>(p2gz->early_blues_trainer, &EarlyBluesTrainer::toggle_inset_vertical_inversion)))
				))
		))
		...
		->push(new OpenSubMenuOption("timer", (new ListMenu(new Delegate<Timer>(p2gz->timer, &Timer::sync)))
			...
			->push(new OpenSubMenuOption("segment timer", (new ListMenu())
				->push(new ToggleMenuOption("enabled", false, new Delegate1<Timer, bool>(p2gz->timer, &Timer::set_segment_timer_enabled)))
				...
				->push(new ToggleMenuOption("split on captain swap", false, new Delegate1<Timer, bool>(p2gz->timer, &Timer::set_split_on_captain_swap_enabled)))
				->push(new ToggleMenuOption("split on gate segment", false, new Delegate1<Timer, bool>(p2gz->timer, &Timer::set_split_on_gate_seg_enabled)))
				->push(new ToggleMenuOption("split on gate destroyed", false, new Delegate1<Timer, bool>(p2gz->timer, &Timer::set_split_on_gate_down_enabled)))
				->push(new ToggleMenuOption("split on bag crush", false, new Delegate1<Timer, bool>(p2gz->timer, &Timer::set_split_on_bag_crush_enabled)))
				->push(new ToggleMenuOption("split on poisoned CS", false, new Delegate1<Timer, bool>(p2gz->timer, &Timer::set_split_on_poison_demo_enabled)))
				...
				->push(new ToggleMenuOption("split on cave enter", true, new Delegate1<Timer, bool>(p2gz->timer, &Timer::set_split_on_cave_enter_enabled)))
			))
		))
...
void GZMenu::update()
{
	...
	// The menu is fully locked out during race mode
