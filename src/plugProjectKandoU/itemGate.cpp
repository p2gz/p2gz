...
void ItemGate::doLoad(Stream& stream)
{
	...
	if (mSegmentsDown >= mMaxSegments) {
		// @P2GZ: make itemGate.cpp equivalent - remove shift-JIS errors caused by comment
...
{
	// @P2GZ: make itemGate.cpp equivalent - this function now matches
	f32 workDist0 = 0.0f;
...
{
	// @P2GZ: make itemGate.cpp equivalent - this function should be equivalent up to regswaps and stack nonsense
...
// @P2GZ: make itemGate.cpp equivalent - these are all weak functions, now moved to headers
// /**
