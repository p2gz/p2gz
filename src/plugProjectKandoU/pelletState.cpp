...
bool PelletGoalState::checkMovie(Pellet* pelt)
{
	...
	if (gameSystem->isStoryMode()) {
		...
		if (enemy != nullptr && (enemy->getEnemyTypeID() == EnemyTypeID::EnemyID_YellowKochappy || enemy->getEnemyTypeID() == EnemyTypeID::EnemyID_UjiA || enemy->getEnemyTypeID() == EnemyTypeID::EnemyID_UjiB) && !playData->isDemoFlag(DEMO_First_Corpse_In_Cave)) {
